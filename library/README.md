...
| Ellipsoidal fit | $$ \mathbf{m}_\text{cal} = \mathbf{A}(\mathbf{m}_\text{raw} - \mathbf{b}) $$ | - Hard-iron offset<br/> - Non-uniform scale factor<br/>- Symmetric (non-uniform) cross-axis coupling |
